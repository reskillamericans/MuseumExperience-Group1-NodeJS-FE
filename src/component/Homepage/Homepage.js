...
function Homepage() {
    return (
        ...
        <div className='container'>
            <h1>WELCOME TO <br /> MUSEUM EXPERIENCE!</h1>
            <div className='hero' style={{ backgroundImage: `url(${hero})` }}>
                <div className='heroCenter'>
                    <p className='heroTitle'>Welcome to the Museum Experience!</p>
                    <p className='heroSubTitle'>Explore exhibition galleries, videos, articles, and more.</p>
                    <a className='heroLink' target="_blank" rel="noreferrer" href="#"><div className='heroBtn'>Click to continue</div></a>
                </div>
            </div>
